 ...
 *
 */
public class StatisticPromoterDayLog implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 4116250055240471568L;
	/***/
	private Integer id;
	/***/
	...
	public void setWithdrawCommision(Double withdrawCommision) {
		this.withdrawCommision = DoubleUtils.scaleFormatEnd(withdrawCommision,2);
	}
	...
	public void setCommisionBalance(Double commisionBalance) {
		this.commisionBalance = DoubleUtils.scaleFormatEnd(commisionBalance,2);
	}
