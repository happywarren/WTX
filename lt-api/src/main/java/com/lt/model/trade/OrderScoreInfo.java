...
public class OrderScoreInfo implements Serializable{
	...
	public OrderScoreInfo(){}
	
	public OrderScoreInfo(String userId, String investorId, String orderId,
	...
	public void setShouldCouponFund(Double shouldCouponFund) {
		this.shouldCouponFund = shouldCouponFund;
	}
	...
	public void setActualCouponFund(Double actualCouponFund) {
		this.actualCouponFund = actualCouponFund;
	}
	...
	public void setThisSysLossProfit(Double thisSysLossProfit) {
		this.thisSysLossProfit = thisSysLossProfit;
	}
	...
	public void setThisLossProfit(Double thisLossProfit) {
		this.thisLossProfit = thisLossProfit;
	}
