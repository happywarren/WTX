...
public interface DeferService {
	 ...
	 * @return
	 */
	public double getOrderDeferredFee(Integer plate, Integer tradeDirection, String inverstorId,double deferInterest,String productCode);
}
