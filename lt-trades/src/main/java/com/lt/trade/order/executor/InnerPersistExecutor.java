...
public class InnerPersistExecutor extends AbstractPersistExecutor implements InitializingBean {
	...
	@Autowired
	private IScoreOrderPersistService scoreOrderInnerPlatePersistServiceImpl;
	 ...
	 * @author XieZhibing
	 * @date 2016年12月12日 上午10:02:16
	 * @see com.lt.trade.order.executor.BasePersistExecutor#getQueue()
	 * @return
	 */
	@Override
...
//		return null;
		return this.scoreOrderInnerPlatePersistServiceImpl;
	}
