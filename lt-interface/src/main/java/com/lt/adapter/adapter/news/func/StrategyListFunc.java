...
/**
 * 项目名称：lt-interface 类名称：StrategyListFunc 类描述： 创建人：yuanxin 创建时间：2017年3月3日
 * 下午1:43:12
 */
@Component
public class StrategyListFunc extends BaseFunction {
	...
	public Response response(Map<String, Object> paraMap) {
		...
		String brandId = StringTools.formatStr(paraMap.get("brand"), "") ;
		List<NewsArticleVo> data = newsArticleApiService.queryStrategyList(brandId,pageNoStr, pageSizeStr);
