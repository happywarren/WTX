...
package com.lt.tms.library.ib.controller;
...
import com.lt.tms.library.ib.client.CommissionReport;
import com.lt.tms.library.ib.client.Contract;
import com.lt.tms.library.ib.client.ContractDescription;
import com.lt.tms.library.ib.client.ContractDetails;
import com.lt.tms.library.ib.client.DeltaNeutralContract;
import com.lt.tms.library.ib.client.DepthMktDataDescription;
import com.lt.tms.library.ib.client.EClientErrors;
import com.lt.tms.library.ib.client.EJavaSignal;
import com.lt.tms.library.ib.client.EReader;
import com.lt.tms.library.ib.client.EReaderSignal;
import com.lt.tms.library.ib.client.EWrapper;
import com.lt.tms.library.ib.client.Execution;
import com.lt.tms.library.ib.client.ExecutionFilter;
import com.lt.tms.library.ib.client.FamilyCode;
import com.lt.tms.library.ib.client.MarketDataType;
import com.lt.tms.library.ib.client.NewsProvider;
import com.lt.tms.library.ib.client.Order;
import com.lt.tms.library.ib.client.OrderState;
import com.lt.tms.library.ib.client.OrderStatus;
import com.lt.tms.library.ib.client.ScannerSubscription;
import com.lt.tms.library.ib.client.SoftDollarTier;
import com.lt.tms.library.ib.client.TagValue;
import com.lt.tms.library.ib.client.TickAttr;
import com.lt.tms.library.ib.client.TickType;
import com.lt.tms.library.ib.controller.ApiConnection.ILogger;
...
public class ApiController implements EWrapper {
	...
	@Override public void nextValidId(int orderId) {
		m_orderId = orderId;
		m_reqId = m_orderId + 10000000; // let trade id's not collide with other request id's
		m_connected  = true;
	...
	public void updateGroups( ArrayList<Group> groups) {
		...
		m_client.replaceFA( Types.FADataType.GROUPS.ordinal(), AdvisorUtil.getGroupsXml( groups) );
		sendEOM();
	}
	...
	public void updateProfiles(ArrayList<Profile> profiles) {
		...
		m_client.replaceFA( Types.FADataType.PROFILES.ordinal(), AdvisorUtil.getProfilesXml( profiles) );
		sendEOM();
	}
	...
	/** This interface is for receiving events for a specific trade placed from the API.
	...
	public void placeOrModifyOrder(Contract contract, final Order order, final IOrderHandler handler) {
		...
		// when placing new trade, assign new trade id
		if (order.orderId() == 0) {
