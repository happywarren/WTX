...
public class Order {
    ...
    private int  m_parentId; // Parent trade Id, to associate Auto STP or TRAIL orders with the original trade.
    ...
    private String   m_clearingAccount; // True beneficiary of the trade
    ...
    private boolean m_transmit = true; // if false, trade will be sent to TWS but not transmitted to server
	...
	// getters
    public Types.Action action()              { return Types.Action.get(m_action); }
    ...
    public Types.Method faMethod()            { return Types.Method.get(m_faMethod); }
    public String getFaMethod()         { return m_faMethod; }
    public Types.OcaType ocaType()            { return Types.OcaType.get(m_ocaType); }
    ...
    public Types.Rule80A rule80A()            { return Types.Rule80A.get(m_rule80A); }
    ...
    public Types.AlgoStrategy algoStrategy()  { return Types.AlgoStrategy.get(m_algoStrategy); }
    ...
    public Types.HedgeType hedgeType()        { return Types.HedgeType.get(m_hedgeType); }
    ...
    public Types.TimeInForce tif()            { return Types.TimeInForce.get(m_tif); }
    ...
    public Types.VolatilityType volatilityType() { return Types.VolatilityType.get(m_volatilityType); }
    public int getVolatilityType()      { return m_volatilityType; }
    public Types.TriggerMethod triggerMethod()   { return Types.TriggerMethod.get(m_triggerMethod); }
    ...
    public Types.ReferencePriceType referencePriceType() { return Types.ReferencePriceType.get(m_referencePriceType); }
    ...
    public void action(Types.Action v)                { m_action = ( v == null ) ? null : v.getApiString(); }
    public void action(String v)                { m_action = v; }
    public void algoStrategy(Types.AlgoStrategy v)    { m_algoStrategy = ( v == null ) ? null : v.getApiString(); }
    ...
    public void faMethod(Types.Method v)              { m_faMethod = ( v == null ) ? null : v.getApiString(); }
    ...
    public void hedgeType(Types.HedgeType v)          { m_hedgeType = ( v == null ) ? null : v.getApiString(); }
    ...
    public void ocaType(Types.OcaType v)              { m_ocaType = ( v == null ) ? 0 : v.ordinal(); }
    ...
    public void referencePriceType(Types.ReferencePriceType v) { m_referencePriceType = ( v == null ) ? 0 : v.ordinal(); }
    public void referencePriceType(int v)       { m_referencePriceType = v; }
    public void rule80A(Types.Rule80A v)              { m_rule80A = ( v == null ) ? null : v.getApiString(); }
    ...
    public void tif(Types.TimeInForce v)              { m_tif = ( v == null ) ? null : v.getApiString(); }
    ...
    public void triggerMethod(Types.TriggerMethod v)  { m_triggerMethod = ( v == null ) ? 0 : v.val(); }
    ...
    public void volatilityType(Types.VolatilityType v) { m_volatilityType = ( v == null ) ? 0 : v.ordinal(); }
