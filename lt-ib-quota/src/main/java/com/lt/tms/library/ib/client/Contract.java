...
public class Contract implements Cloneable {
    ...
    // COMBOS
    private String m_comboLegsDescrip; // received in open trade version 14 and up for all combos
    ...
    public Types.SecIdType secIdType()    { return Types.SecIdType.get(m_secIdType); }
    public String getSecIdType()    { return m_secIdType; }
    public Types.SecType secType()        { return Types.SecType.get(m_secType); }
    ...
    public Types.Right right()            { return Types.Right.get(m_right); }
    ...
    public void right(Types.Right v)          { m_right = ( v == null ) ? null : v.getApiString(); }
    public void right(String v)         { m_right = v; }
    public void secId(String v)         { m_secId = v; }
    public void secIdType(Types.SecIdType v)  { m_secIdType = ( v == null ) ? null : v.getApiString(); }
    public void secIdType(String v)     { m_secIdType = v; }
    public void secType(Types.SecType v)      { m_secType = ( v == null ) ? null : v.getApiString(); }
