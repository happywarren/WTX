 ...
 *
 */
public interface ITradeScoreManageService {
	 ...
	 * 强制成功/强制失败/强制平仓-多选
	 * @param param
	 * @param type 操作类型 Success:强制成功 Fail:强制失败 Sell:强制平仓
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public OrderScoreEntrustInfo queryEntrustInfo(OrderParamVO param) throws Exception;
