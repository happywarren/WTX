...
*/
@Service
public class UserCharge1010111Func extends UserRechargeSuper implements UserChargeFunc {
	...
	public Map<String, Object> returnParam(String urlCode, String packet, BaseChargeBean baseCharge)
		...
		String merid = sysCfgRedis.get("xl_alipay_merid3");
		...
		String key = sysCfgRedis.get("xl_alipay_key3");
		...
		alipayRecharge.setBizCode(FundThirdOptCodeEnum.XLPAY3.getThirdLevelCode());
	...
	public boolean insertDataBase(BaseChargeBean baseCharge) throws LTException {
		...
		super.getFundAccountServiceImpl().insertRechargeIo(baseCharge.getUserId(), baseCharge.getPayOrderId(), baseCharge.getAmt(),
				...
				FundThirdOptCodeEnum.XLPAY3.getThirdLevelCode(), baseCharge.getRate());
		return true;
	}
