...
*/
@Service
public class UserCharge1010110Func extends UserRechargeSuper implements UserChargeFunc {
	...
	public Map<String, Object> returnParam(String urlCode, String packet, BaseChargeBean baseCharge)
		...
		String merid = sysCfgRedis.get("xl_alipay_merid2");
		...
		String key = sysCfgRedis.get("xl_alipay_key2");
		...
		alipayRecharge.setBizCode(FundThirdOptCodeEnum.XLPAY2.getThirdLevelCode());
	...
	public boolean insertDataBase(BaseChargeBean baseCharge) throws LTException {
		...
		super.getFundAccountServiceImpl().insertRechargeIo(baseCharge.getUserId(), baseCharge.getPayOrderId(), baseCharge.getAmt(),
				...
				FundThirdOptCodeEnum.XLPAY2.getThirdLevelCode(), baseCharge.getRate());
		return true;
	}
