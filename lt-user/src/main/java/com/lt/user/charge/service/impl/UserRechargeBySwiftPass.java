...
/**   
* 项目名称：lt-user   
* 类名称：UserRechargeBySwiftPass
* 类描述：  支付宝充值（聚合支付） 
* 创建人：yuanxin   
* 创建时间：2017年7月17日 下午3:30:11      
*/
@Service
public class UserRechargeBySwiftPass extends UserRechargeSuper implements UserChargeFunc {
	...
	public Map<String, Object> returnParam(String urlCode, String packet, BaseChargeBean baseCharge)
		...
		model.setMchId(jsonObject.getString("mchId"));
		model.setNotifyUrl(jsonObject.getString("notifyUrl"));
		//必要参数
	...
	public boolean insertDataBase(BaseChargeBean baseCharge) throws LTException {
		...
		super.getFundAccountServiceImpl().insertRechargeIo(baseCharge.getUserId(), baseCharge.getPayOrderId(), baseCharge.getAmt(),
				baseCharge.getRmbAmt(), baseCharge.getBankCardNum(),baseCharge.getBankCode(),baseCharge.getChannelId(), baseCharge.getRate());
		return true;
	}
