...
/**   
* 项目名称：lt-user   
* 类名称：UserCharge1010115Func   
* 类描述：  支付宝充值（聚合支付） 
* 创建人：yuanxin   
* 创建时间：2017年7月17日 下午3:30:11      
*/
@Service
public class UserCharge1010115Func extends UserRechargeSuper implements UserChargeFunc {
	...
	public Map<String, Object> returnParam(String urlCode, String packet, BaseChargeBean baseCharge)
		...
		String merid = sysCfgRedis.get("xl_alipay_merid7");
		...
		String key = sysCfgRedis.get("xl_alipay_key7");
		...
		alipayRecharge.setBizCode(FundThirdOptCodeEnum.XLPAY7.getThirdLevelCode());
	...
	public boolean insertDataBase(BaseChargeBean baseCharge) throws LTException {
		...
		super.getFundAccountServiceImpl().insertRechargeIo(baseCharge.getUserId(), baseCharge.getPayOrderId(), baseCharge.getAmt(),
				...
				FundThirdOptCodeEnum.XLPAY7.getThirdLevelCode(), baseCharge.getRate());
		return true;
	}
