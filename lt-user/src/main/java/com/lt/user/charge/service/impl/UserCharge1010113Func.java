...
*/
@Service
public class UserCharge1010113Func extends UserRechargeSuper implements UserChargeFunc {
	...
	public Map<String, Object> returnParam(String urlCode, String packet, BaseChargeBean baseCharge)
		...
		String merid = sysCfgRedis.get("xl_alipay_merid5");
		...
		String key = sysCfgRedis.get("xl_alipay_key5");
		...
		alipayRecharge.setBizCode(FundThirdOptCodeEnum.XLPAY5.getThirdLevelCode());
	...
	public boolean insertDataBase(BaseChargeBean baseCharge) throws LTException {
		...
		super.getFundAccountServiceImpl().insertRechargeIo(baseCharge.getUserId(), baseCharge.getPayOrderId(), baseCharge.getAmt(),
				...
				FundThirdOptCodeEnum.XLPAY5.getThirdLevelCode(), baseCharge.getRate());
		return true;
	}
