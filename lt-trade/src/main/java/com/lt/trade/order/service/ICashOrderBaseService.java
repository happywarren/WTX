 ...
 * FILE    NAME: ICashOrderService.java
 ...
 * @version <b>1.0.0</b>
 */
public interface ICashOrderBaseService {
	...
	/*public void doPersist2003(String matchDateTime, Integer matchVol,
			...
			String sysMatchId, OrderCashEntrustInfo entrustRecord);*/
	...
	/**
	 * 更新持仓数量、买入(卖出)成功数量、买入(卖出)失败数量、买入(卖出)均价、买入(卖出)时间、添加成交记录
	 * @param matchBean
	 * @param entrustRecord
	 */
