...
public class ScoreOrderBuyTradeServiceImpl extends AbstractScoreOrderTradeSerivce implements IOrderBuyTradeService {
	...
	public void doBuy(OrderVo orderVo) throws LTException {
		...
		//获取商品手续费
		InvestorProductConfig config = null;
		if(info.getInvestorAccountId() != null){
			config =  investorProductConfigApiService.findInvestorProductConfig(info.getInvestorAccountId(), product.getProductCode());
