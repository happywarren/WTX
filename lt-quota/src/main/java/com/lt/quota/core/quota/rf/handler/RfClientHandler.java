package com.lt.quota.core.quota.rf.handler;
...
public class RfClientHandler extends SimpleChannelInboundHandler<String> {

    private Logger logger = LoggerFactory.getLogger(RfClientHandler.class);

    private OnMessageListener messageListener;

    public RfClientHandler(OnMessageListener messageListener) {
