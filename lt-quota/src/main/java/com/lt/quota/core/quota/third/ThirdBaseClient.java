...
import com.lt.quota.core.quota.third.handler.GzipDecoder;
 ...
 */
public class ThirdBaseClient implements Runnable {

    private static Logger logger = LoggerFactory.getLogger(ThirdBaseClient.class);
    ...
    public ThirdBaseClient(String host, int port, OnStartupListener startupListener) {
        this.host = host;
        this.port = port;
        this.startupListener = startupListener;
    }

    public ThirdBaseClient(String host, int port, ChannelHandler channelHandler, OnStartupListener startupListener) {
        this.host = host;
        this.port = port;
        ...
        try {
            ...
            b.handler(new ChannelInitializer<SocketChannel>() {
                ...
                protected void initChannel(SocketChannel ch) throws Exception {
                    ...
                    p.addLast(new LengthFieldBasedFrameDecoder(ByteOrder.LITTLE_ENDIAN,16777216, 0, 4, 0, 4,true));
            ...
            LengthFieldBasedFrameDecoder l ;
